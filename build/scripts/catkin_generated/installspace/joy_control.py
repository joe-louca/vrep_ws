...
def joy_pose_goal():
    ...
    while not rospy.is_shutdown():        
        ...
        curr_r, curr_p, curr_ = QuarternionToEuler(curr_rot[0], curr_rot[1], curr_rot[2], curr_rot[3])
                  
        new_r = curr_r + rot_step_size * ax[3]
        new_p = curr_p + rot_step_size * ax[4]
        new_y = curr_y + rot_step_size * ax[5] 

        new_qx, new_qy, new_qz, new_qw = EulerToQuaternion(new_r, new_p, new_y)                    
