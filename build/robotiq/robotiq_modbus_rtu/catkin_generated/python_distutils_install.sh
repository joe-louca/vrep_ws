...
echo_and_run cd "/home/joe/vrep_ws/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/joe/vrep_ws/src/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/joe/vrep_ws/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
