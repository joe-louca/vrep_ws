...
echo_and_run cd "/home/joe/vrep_ws/src/robotiq_2finger_grippers/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/joe/vrep_ws/src/robotiq_2finger_grippers/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/home/joe/vrep_ws/build/robotiq_2finger_grippers/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
