...
echo_and_run cd "/home/joe/vrep_ws/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/joe/vrep_ws/src/universal_robot/ur_driver/setup.py" \
     \
    build --build-base "/home/joe/vrep_ws/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
